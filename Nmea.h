...
public:
    ...
    static int nmeaParseGpgga(QString *str, nmeaGPGGA *pack);
    static int nmeaParseGpgsa(QString *str, nmeaGPGSA *pack);
    static int nmeaParseGpgsv(QString *str, nmeaGPGSV *pack);
    static int nmeaParseGprmc(QString *str, nmeaGPRMC *pack);
    static int nmeaParseGpvtg(QString *str, nmeaGPVTG *pack);
    static int nmeaParseGpgll(QString *str, nmeaGPGLL *pack);
    static int nmeaParseGpzda(QString *str, nmeaGPZDA *pack);
    static int nmeaParseGptxt(QString *str, nmeaGPTXT *pack);
